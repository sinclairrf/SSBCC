...
# Remove the AXI ports auto-generated by Vivado 2013.3.
...
ipx::remove_address_space {i_axi_eMaginMaster} [ipx::current_core]
ipx::remove_address_space {o_axi_eMaginMaster} [ipx::current_core]
ipx::add_address_space {axi_eMaginMaster} [ipx::current_core]
set_property master_address_space_ref {axi_eMaginMaster} [ipx::get_bus_interface axi_eMaginMaster [ipx::current_core]]
""";
